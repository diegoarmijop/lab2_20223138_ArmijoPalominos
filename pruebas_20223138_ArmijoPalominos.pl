%Script de prueba
%El codigo presentado a continuacion contiene ejemplos que le permitiran verificar la funcionalidad del codigo main (tda-image_20223138_ArmijoPalominos). 
%Para probarlos solo basta con ejecutar el archivo main en la base de consulas e ir copiandolos y ejecutandolos. 
%Se recomienda usas set_prolog_flag(answer_write_options,[max_depth(0)]). en la base de consultas para que se muestren los datos en su totalidad. 
...
%Probar que imageIsBitmap detecta cuando se tiene una imagen hex o en rgb.
%pixbit( 0, 0, 1, 10, PA), pixbit( 0, 1, 0, 20, PB), pixbit( 1, 0, 0, 30, PC), pixbit( 1, 1, 1, 4, PD), image( 2, 2, [PA, PB, PC, PD], I), imageIsBitmap(I).

%Casos en los que da falso:
...
%pixrgb( 0, 0, 255, 0, 0, 10, PA), pixrgb( 0, 1, 255, 0, 0, 20, PB), pixrgb( 1, 0, 0, 0, 255, 30, PC), pixrgb( 1, 1, 0, 0, 255, 4, PD), image( 2, 2, [PA, PB, PC, PD], I).
